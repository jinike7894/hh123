...
class TianHui extends PaymentBase
{
    public $payName = 'TianHui';
    ...
    public function createOrder($data)
    {
        ...
        $postData['pay_productname'] = 'vip';
        $postData['pay_ip'] = '127.0.0.1';
...
array(5) {
  ...
  string(84) "http://dying2.jingxin900.com/index.php/index/index/order?id=WDIwMjMxMjIxMTYxMTM2T3pV"
        ...
        // 这里一定要注意返回的字段要满足要求
        return [
            'tradeNo' => $responseArr['order_id'],
            'payUrl' => $responseArr['h5_url'],
            'expiredTime' => 0,
        ];
    }
